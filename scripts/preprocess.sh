...
VIDEO_DIR=~/notebook/dataset/videos/video_5k/train_5k #视频存放目录
DATA_ROOT=~/notebook/dataset           #特征存放目录
#INFO_FILE=$DATA_ROOT/info_files/tagging.txt #视频标签对应文件
#TAG_DICT_FILE=$DATA_ROOT/dict/tag-id-tagging.txt #标签字典文件, 字典文件变动需要修改
INFO_FILE=$DATA_ROOT/structuring/GroundTruth/structuring_tagging_info.txt  #视频标签对应文件
TAG_DICT_FILE=${DATA_ROOT}/label_id.txt #标签字典文件, 字典文件变动需要修改
